...
namespace Kata.Spec
{
    ...
    public class when_user_input_is_two_numbers
    {
        ...
        It should_return_the_sum_of_the_numbers = () => { _result.Should().Be(7); };
        static Calculator _systemUnderTest;
        static int _result;
    }

    public class when_user_input_is_more_than_two_numbers
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_using__new_line_as_delimiter
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
    ...
    public class when_user_input_contains_more_than_one_negative_number
    {
        Establish _context = () =>
        {
            _systemUnderTest = new Calculator();
        ...
        Because of = () => { _result = Catch.Exception(() =>
            _systemUnderTest.Add("1,-2,3,-4")); };

        It should_throw_an_exception_with_all_negative_numbers = () => { _result.Message.Should().Be("negatives not allowed: -2, -4"); };
        private static Calculator _systemUnderTest;
